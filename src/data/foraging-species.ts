...
export const FORAGE_SPECIES: ForageSpecies[] = [
  {
    "name": "Acorns (white oak group)",
    "scientific": "Quercus alba and other white-oak-group species (Q. macrocarpa, Q. bicolor, Q. montana, Q. muehlenbergii, Q. garryana, Q. lobata, Q. gambelii)",
    "months": [
      7,
      8,
      9,
    ...
    "habitat": "White-oak-group oaks reach every US region: Q. alba, Q. montana and Q. muehlenbergii through the Northeast and Southeast; Q. macrocarpa and Q. bicolor across the Midwest; Q. gambelii and Q. arizonica in the Southwest; Q. lobata and Q. douglasii in California's valleys and foothills; and Q. garryana from southern California north through Oregon and Washington to Vancouver Island. Most are upland trees of dry slopes, ridges, ravines and oak-hickory or oak-savanna edge, though Q. bicolor and the swamp chestnut oaks hold bottomland and stream terraces. Street and park oaks fruit heavily and are the easiest gleaning, but that is also exactly where horse chestnut is planted as a shade tree, so identify the tree standing over you before you pick anything off the pavement.",
    "indicator": "Pale ash-grey, flaky-plated bark on a broad open crown with hickories mixed in, and a scatter of scaly cup-caps and squirrel-cut shell halves already on the ground.",
    "parts": "Kernel only, and only after leaching. Identify the tree first: white-oak-group leaves and teeth end blunt, with no bristle or hair point at any tip (NC State describes Q. alba as 5 to 9 deep, rounded, even lobes with no bristles), and the acorn matures in a single season, about 120 days from pollination per USDA Silvics. Shell the nuts and discard any with weevil exit holes, dark discoloration or mould. Then remove the tannins by one of three routes: steep whole or halved kernels in repeated changes of cold water over several days to a couple of weeks; grind to meal and rinse the meal six to twenty times until it is no longer astringent (McClung Museum); or boil kernels in repeated changes of water, about fifteen minutes a change, until the water stops running brown, which is the method the Lady Bird Johnson Wildflower Center recommends. Boiling is much the fastest but cooks the starch, so hot-leached meal suits porridge, mush and pudding while cold-leached flour is what binds in baking. Never eat them raw or under-leached: NC State lists gallotannins in the seed as causing abdominal pain, then constipation followed by diarrhoea. White-oak-group acorns leach in a fraction of the time red-oak-group acorns need.",
    "caution": "expert",
    "lookalikes": [
      {
        "name": "Horse chestnut / conker (Aesculus hippocastanum)",
        "danger": "deadly",
        "tell": "Ignore size - it proves nothing, because bur oak acorns run to about 1.5 in and valley oak acorns are also large. Read the nut instead. A horse chestnut seed is a glossy dark-mahogany sphere, flattened on one side, carrying one broad matte pale-tan scar over a third or more of one face, with no point at either end. Every acorn tapers to a small hard point at its apex (the dried style) and shows only a small circular scar at its base where the cap sat, and its shell is dull tan, often faintly striped lengthwise. Overhead the difference is absolute: oaks have simple, alternate leaves, while Aesculus has opposite, palmately compound leaves of 5 to 7 leaflets radiating from one stalk, and drops a prickly leathery capsule 1 to 2 in across rather than a scaly cup. NC State Extension rates it Poison Severity: High and states it is highly toxic and may be fatal if eaten; poison-centre case reports describe muscle weakness, difficulty walking, paralysis, twitching, hypotension, collapse and airway-blocking swelling after only 1 to 4 seeds."
      },
      {
        "name": "Native buckeyes (Aesculus glabra, A. flava, A. pavia, A. californica)",
        "danger": "deadly",
        "tell": "Same seed anatomy as horse chestnut: a round, glossy brown seed with one broad pale hilum scar (the 'buck's eye'), no cap scar, no pointed apex, shed from a warty or prickly leathery capsule; and the same opposite, palmately compound leaves overhead. California buckeye is the specific trap in the West, dropping big smooth brown seeds into the same blue oak and valley oak woodland at the same time of year as the acorns you want. NC State Extension lists muscle weakness, dilated pupils, vomiting, diarrhoea, paralysis and stupor."
      },
      {
        "name": "Red / black oak group acorns (Quercus rubra, Q. velutina, Q. palustris and relatives)",
        "danger": "unpalatable",
        "tell": "Not poisonous, but heavily tannic and a far longer leach, and eaten under-leached they cause real gastrointestinal distress. Turn a leaf over: red-group lobes and teeth end in fine bristle points, white-group ones end blunt. Crack a nut: the red-group kernel is wrapped in a fuzzy skin and the inside of the shell is woolly, while white-group kernels and shell interiors are smooth. Red-group acorns also take two seasons to ripen, so a fruiting twig carries both pea-sized first-year acorns and full-sized second-year ones at once; white-group twigs carry only one size."
      }
    ],
    "harvest": "Oak mast is boom-and-bust and species-specific: USDA Silvics gives white oak (Q. alba) good crops only every 4 to 10 years, with years of nothing between, while USDA's Southern Research Station gives bur oak a good crop every 2 to 3 years. Acorns are the winter calorie base for deer, bear, turkey, squirrels and jays, so take a share only in a heavy year, spread the take across several trees, and leave a poor year alone entirely. Gather promptly off the ground: white-oak-group acorns germinate almost immediately after falling in September and October (USDA Silvics), so a short white radicle means a fresh acorn, not a spoiled one. Screen by cutting a sample open rather than trusting the float test alone - a West Virginia University study that dissected nearly twenty thousand acorns found only 56 percent of genuinely sound acorns sank, so about half of good nuts float, while early-stage weevil larvae leave the acorn heavy enough to sink and pass. Treat floaters as suspect, not condemned, and back the test with visual inspection for exit holes, dark staining and shrivelled kernels. Dry the shelled kernels for storage, or leach and freeze.",
    "sources": [
      "USDA Forest Service, Silvics of North America: White Oak (Quercus alba) - 120-day acorn maturation, September-October drop and immediate germination, good crops every 4 to 10 years - https://research.fs.usda.gov/silvics/white-oak",
      "USDA Forest Service, Silvics of North America: Oregon White Oak (Quercus garryana) - Vancouver Island to Los Angeles County range, acorns ripen late August to November - https://research.fs.usda.gov/silvics/oregon-white-oak",
      "USDA Forest Service, Southern Research Station, Silvics of North America: Bur Oak (Quercus macrocarpa) - largest acorns of any native oak, drop from August to November, good crops every 2 to 3 years - https://www.srs.fs.usda.gov/pubs/misc/ag_654/volume_2/quercus/macrocarpa.htm",
      "NC State Extension Gardener Plant Toolbox, Quercus alba - rounded lobes with no bristles, acorn 3/4 to 1 in, edible after tannins are leached, gallotannin symptoms - https://plants.ces.ncsu.edu/plants/quercus-alba/",
      "NC State Extension Gardener Plant Toolbox, Aesculus hippocastanum - Poison Severity: High, 'HIGHLY TOXIC, MAY BE FATAL IF EATEN', prickly leathery 1-2 in capsule, shiny brown seeds with a pale scar - https://plants.ces.ncsu.edu/plants/aesculus-hippocastanum/",
      "NC State Extension Gardener Plant Toolbox, Aesculus glabra - warty or prickly leathery capsule, 1-3 shiny brown seeds each with a pale 'buck's eye' scar, paralysis and stupor among symptoms - https://plants.ces.ncsu.edu/plants/aesculus-glabra/",
      "National Capital Poison Center, 'Horse chestnuts are toxic' - severe poisoning from 1 to 4 seeds, weakness, paralysis, twitching, collapse and angioedema - https://www.poison.org/articles/horse-chestnuts-are-toxic-214",
      "Missouri Poison Center, 'Horse Chestnut' - seed pods with widely spaced burrs, pale spot on the nut, gastrointestinal effects - https://missouripoisoncenter.org/is-this-a-poison/horse-chestnut/",
      "McClung Museum, University of Tennessee, 'Plant of the Month: Acorn' - white versus red oak tannin load, stream leaching and rinsing acorn flour six to twenty times - https://mcclungmuseum.utk.edu/2022/11/29/plantofthemonth-acorn/",
      "Lady Bird Johnson Wildflower Center, University of Texas at Austin, expert answer on removing tannins from acorns - boiling in repeated changes of water until the water no longer runs brown - https://www.wildflower.org/expert/show.php?id=2947",
      "Gribko & Jones, 'Test of the Float Method of Assessing Northern Red Oak Acorn Condition', Tree Planters' Notes 46(4):143-147, West Virginia University - only 56 percent of sound acorns sank; float test should supplement, not replace, visual inspection - https://rngr.net/publications/tpn/46-4/46_4_143_147.PDF/at_download/file"
    ]
  },
  {
    "name": "Black walnut",
    ...
    "habitat": "Deep, well-drained, near-neutral bottomland and cove soils, plus fencerows, old-field edges, roadsides and yards, from New England west to eastern South Dakota and south to western Oklahoma, central Texas and northwest Florida. Those same river-bottom and cove sites are prime yellow buckeye ground - it wants the identical moist, deep, well-drained soil - and horse chestnut is a standard planted shade tree along the very roadsides and yards this entry sends you to, so expect Aesculus fruit underfoot in the same September woods. It will not tolerate poorly drained ground, so skip soggy bottoms; open-grown trees carry by far the heaviest crops. Widely planted well beyond this native range.",
    "indicator": "An open-crowned tree with dark, diamond-furrowed bark standing over conspicuously bare ground - juglone from its roots suppresses plants under the dripline.",
    "parts": "Kernel only. Identify the tree before you pick anything up: alternate, pinnately compound leaves one to two feet long with 15-23 leaflets, dark diamond-furrowed bark, and a fleshy green husk holding exactly one rock-hard, deeply grooved nut - never the opposite, palmate leaves and three-valved capsule of a buckeye. Cut the first fruit of the day through with a knife as a positive check: black walnut is thick fibrous green flesh whose juice stains the blade and your fingers yellow-brown within minutes, wrapped around a single shell the knife cannot enter, while a buckeye is a thin leathery rind over one to three smooth, shell-less seeds the blade slices straight through into solid ivory. The husk is not food: its juice stains skin, clothing and concrete brown for weeks and can irritate skin, so wear rubber gloves. Only once the tree is confirmed does ripeness matter - gather when the green husk dents under thumb pressure, then hull the same day, because a two-week delay in husk removal turns kernels black and rancid. The dent test is a ripeness test and nothing more: a green buckeye capsule dents under thumb pressure too, so it can never stand in for identification. Wash the nuts, throw out any that are mouldy or whose shells are cracked or fissured, then cure them in a single layer one nut deep in a cool, dry, ventilated spot out of direct sun for two to three weeks before cracking. Keep shelled kernels in the fridge or freezer; the oil goes rancid quickly.",
    "caution": "expert",
    "lookalikes": [
      {
        "name": "Buckeyes and horse chestnut (Aesculus flava, A. glabra, A. hippocastanum, A. pavia)",
        "danger": "deadly",
        "tell": "Habitat and calendar put this one directly under your feet: yellow buckeye (A. flava) grows in the same river bottoms, coves and moist north slopes as black walnut and drops a smooth, round, leathery capsule 1.5-2 in across - the same size and silhouette as a green walnut hull; Ohio buckeye (A. glabra) fruits September-October in the same rich valley, ravine and low-woods edge; and horse chestnut is a standard yard and street planting. Thumb pressure will not separate them - a green Aesculus capsule dents too - so cut the fruit through. Black walnut is thick fibrous green flesh, sharply aromatic, whose juice stains the blade and your fingers yellow-brown within minutes, around one rock-hard, deeply corrugated shell the knife cannot enter. Aesculus is a thin leathery rind peeling off one to three smooth, shell-less seeds - glossy mahogany when ripe, pale ivory when green, each with one large pale scar - that the blade cuts straight into as solid ivory, with no stain and no smell. A drying Aesculus capsule shows three sutures and splits into three valves; a walnut husk is fleshy and never splits. Overhead the difference is absolute: Aesculus leaves are opposite and palmate, five to seven leaflets radiating from one point; walnut leaves are alternate and pinnate, 15-23 leaflets along a stalk one to two feet long. NC State Extension rates both A. flava and A. hippocastanum Poison Severity: High, saying of yellow buckeye that it can cause death in humans, livestock and pets and of horse chestnut that it is highly toxic and may be fatal if eaten; poison centres record severe poisoning - weakness, twitching, paralysis, collapse, airway swelling - after only one to four seeds, with children the usual casualties. No Aesculus seed is edible by any preparation, and no amount of leaching makes one safe."
      },
      {
        "name": "Osage orange (Maclura pomifera)",
        "danger": "unpalatable",
        "tell": "Osage orange fruit is a 4-5 inch yellow-green ball with a wrinkled, brainlike surface that bleeds sticky white latex (a skin irritant) when cut; its leaves are simple, glossy and smooth-edged and its twigs carry straight half-inch thorns. Black walnut fruit is a smooth green sphere about 1.5-2.5 inches across holding one hard nut, on a thornless tree with pinnately compound leaves."
      }
    ],
    "harvest": "Pick nuts up off the ground within a few days of the drop, never from the tree. Ask permission for yard trees, and skip trees on sprayed lawns, sprayed rights-of-way and busy road shoulders. Spread your take across several heavy-bearing yard or roadside trees rather than stripping one isolated woodland tree, whose crop is winter mast for squirrels, deer and turkey. Discard any nut that overwintered on the ground, shows mould, or has a cracked or fissured shell: Penicillium crustosum growing on fallen walnuts produces the tremorgenic mycotoxin penitrem A, documented in dog poisonings and in one adult man who ate about eight mouldy kernels and developed tremors, incoordination and confusion within 12 hours. Anyone with a tree-nut allergy should not eat these at all - walnut is a major food allergen and anaphylaxis is the one hazard here that genuinely kills. Oblong, sticky-hairy fruits are butternut (Juglans cinerea): also edible, but leave them, as the species is collapsing from butternut canker.",
    "sources": [
      "USDA Forest Service, Silvics of North America: Black Walnut (native range, soils, September-October ripening) - https://research.fs.usda.gov/silvics/black-walnut",
      "USDA Forest Service, Silvics of North America: Yellow Buckeye (grows on moist, deep, well-drained soils in river bottoms, coves and northern slopes - the same sites as black walnut) - https://research.fs.usda.gov/silvics/yellow-buckeye",
      "Iowa State University Extension, \"How to Harvest, Crack, and Store Black Walnuts\" (hull immediately; dry two to three weeks; rubber gloves) - https://yardandgarden.extension.iastate.edu/how-to/how-harvest-crack-and-store-black-walnuts",
      "University of Illinois Extension, \"Preparing Black Walnuts for Eating\" (collect late September to early October; husk dents under a finger when mature) - https://extension.illinois.edu/blogs/extensions-greatest-hits/1999-10-02-preparing-black-walnuts-eating",
      "University of Missouri IPM, \"Black Walnuts: Pick Them and Clean Them Up Quickly\" (two-week hulling delay blackens kernels; discard cracked or fissured shells for microbial risk) - https://ipm.missouri.edu/MEG/2009/10/Black-Walnuts-Pick-Them-and-Clean-Them-Up-Quickly",
      "NC State Extension Plant Toolbox, Juglans nigra (non-splitting fleshy husk, 15-23 leaflets, juglone suppresses plants under the dripline) - https://plants.ces.ncsu.edu/plants/juglans-nigra/",
      "NC State Extension Plant Toolbox, Aesculus flava (Poison Severity: High; \"It can cause death in humans, livestock and pets\"; smooth leathery capsule 1.5-2 in wide holding 1-3 shiny seeds with a pale scar) - https://plants.ces.ncsu.edu/plants/aesculus-flava/",
      "NC State Extension Plant Toolbox, Aesculus hippocastanum (Poison Severity: High; \"HIGHLY TOXIC, MAY BE FATAL IF EATEN\"; aesculin and aescin) - https://plants.ces.ncsu.edu/plants/aesculus-hippocastanum/",
      "NC State Extension Plant Toolbox, Aesculus glabra (poison symptoms: muscle weakness, dilated pupils, vomiting, diarrhoea, paralysis and stupor; toxic principle aesculin and aescin in fruits, leaves and stems) - https://plants.ces.ncsu.edu/plants/aesculus-glabra/",
      "National Capital Poison Center, \"Horse chestnuts are toxic\" (severe poisoning from 1 to 4 seeds: weakness, paralysis, twitching, collapse, angioedema) - https://www.poison.org/articles/horse-chestnuts-are-toxic-214",
      "Clemson HGIC, \"Buckeyes & Horsechestnuts\" (capsules split open; seeds resemble chestnuts but are quite poisonous; palmately compound leaves) - https://hgic.clemson.edu/factsheet/buckeyes-horsechestnuts/",
      "Missouri Department of Conservation field guide, Ohio buckeye (fruits September-October; leathery capsule 1-2.25 in splitting into three parts; shiny brown seeds; opposite palmate leaves; rich woods of valleys, ravines, slopes and edges of low woods) - https://mdc.mo.gov/discover-nature/field-guide/ohio-buckeye",
      "Missouri Department of Conservation field guide, Osage orange (4-5 inch brainlike fruit, milky sap that irritates skin, thorny twigs, simple leaves) - https://mdc.mo.gov/discover-nature/field-guide/osage-orange",
      "Mycotoxin Research (2019), \"Putative neuromycotoxicoses in an adult male following ingestion of moldy walnuts,\" PMID 30088215 - https://pubmed.ncbi.nlm.nih.gov/30088215/",
      "Mycopathologia (1981), \"Moldy walnut toxicosis in a dog, caused by the mycotoxin, penitrem A,\" PMID 7312021 - https://pubmed.ncbi.nlm.nih.gov/7312021/",
      "MedlinePlus (NIH), Food Allergy (tree nuts including walnuts; anaphylaxis is a life-threatening reaction) - https://medlineplus.gov/foodallergy.html"
    ]
  },
  {
    "name": "Burdock root",
  ...
  },
  {
    ...
    "habitat": "Oak-hickory woods, fertile upland slopes, and old fencerows and pasture edges, from southeastern Minnesota and southeastern Nebraska east through southern Ontario to southern Maine, south to Georgia, Alabama, Mississippi, Louisiana and eastern Texas (west also to eastern Kansas and eastern Oklahoma). It is largely absent from the southeastern and Gulf coastal plains, the lower Mississippi Delta and Florida, so do not expect it on the outer coastal plain. Northern trees hold upland slopes; in the Ohio Valley it favours north- and east-facing slopes of fertile uplands; in Arkansas, Mississippi and Louisiana it is chiefly a river-bottom tree. Identify the tree before you pick anything up: mature trunks break into long, wide gray plates attached at the middle and curving free at one or both ends. Young trees are NOT shaggy - their bark is smooth, tight and gray - so confirm with the leaf: alternate, pinnately compound, 8-14 in long, usually 5 leaflets (sometimes 7) with the terminal three much larger, the teeth fringed with fine hairs.",
    "indicator": "A fertile upland slope or old fencerow in oak-hickory woods, with squirrel-cracked four-part husk shells scattered in the litter under a bearing tree.",
    "parts": "Kernel, raw or toasted; there is no bitterness to leach out, unlike acorns. Gather nuts after they drop, September into November. The thick husk dries and splits free to the base along four grooved sutures; if it will not release, dry the nut about a week and try again. Crack with light hammer taps rather than a lever cracker. Positive check once cracked: the shell is bony and whitish-tan, prominently four-angled toward the tip, and the sweet kernel lies in halves separated by woody partitions - never one solid mass. Dry shelled kernels a week or two in a single layer, then refrigerate or freeze; they are oily and turn rancid or mouldy. Discard any kernel that is dark, shrivelled or mouldy.",
    "caution": "expert",
    "lookalikes": [
      {
        "name": "Buckeye / horse chestnut (Aesculus hippocastanum, A. glabra, A. flava, A. pavia)",
        "danger": "deadly",
        "tell": "A buckeye is a single smooth, rounded, glossy mahogany seed with one broad pale scar covering much of one face, and it has NO bony shell - a knife cuts the coat and the inside is one solid ivory mass. A hickory nut is angular with four ridges toward the tip, dull whitish-tan, needs a hammer, and its kernel is in lobed halves divided by woody partitions. The capsule holds 1-3 seeds and splits into 3 valves, not 4; it is prickly in A. hippocastanum and warty-prickly in A. glabra, smooth in A. flava and A. pavia, so spininess proves nothing either way. The tree settles it: Aesculus leaves are OPPOSITE and palmately compound, 5-7 leaflets radiating from one point; hickory leaves are alternate and pinnately compound along a central stalk. Extension services rate the seeds highly toxic and potentially fatal if eaten; children are the usual casualties."
      },
      {
        "name": "Bitternut hickory (Carya cordiformis)",
        "danger": "unpalatable",
        "tell": "Terminal buds are valvate, 4-angled and sulfur-yellow; the bark stays thin, tight and hard, developing shallow furrows and interlacing ridges but never free curling plates; the husk is thin, 4-winged only above the middle, and splits merely from the middle to the sharp-pointed tip instead of freeing four full valves. The kernel is intensely bitter and inedible. Note that the four-part husk alone does not confirm shagbark - shellbark hickory (C. laciniosa, shaggy bark, 7-9 large leaflets) has the same thick 4-valved husk, and its nuts are the largest and sweetest of the hickories."
      },
      {
        "name": "Pignut hickory (Carya glabra)",
        "danger": "unpalatable",
        "tell": "Fruit is obovoid to pear-shaped with a thin husk that only partially splits and often clings; the nut is not four-ridged, being fairly round and flattened, and the kernel is astringent to bitter. Mature pignut bark has close interlacing ridges with shaggy TOPS but attached along their whole length - not the long wide plates of shagbark that stand free of the trunk at one or both ends."
      },
      {
        "name": "Poison ivy vine on the trunk (Toxicodendron radicans)",
        "danger": "toxic",
        "tell": "Mature poison ivy climbs hickories as a rope-like woody vine clothed in dense reddish-brown fibrous aerial rootlets. That fuzz is a round vine lying ON the bark, not bark itself: shagbark plates are gray, flat, wood-thick and free at the ends, while the vine is a cylinder you can trace to the ground and, in leaf, carries leaflets in threes. Urushiol causes severe dermatitis, stays active on dead vines and tools for months to years, and sensitive people can react to smoke from burning vine-covered wood, so do not hug or lever at a furred trunk and do not burn the wood."
      }
    ],
    "harvest": "Hickory is heavy mast for squirrels, turkey, raccoon and bear, and good crops come only every one to three years, so take fallen nuts from several trees rather than clearing under one and leave the bulk of a poor year's crop. Even in a good year only about half the crop is sound - hickory shuckworm, pecan weevil and hickorynut curculio take the rest - so reject nuts that rattle, float, or show a small round exit hole, and freeze what you keep for a couple of days to kill larvae still inside. Skip nuts that have lain on wet ground and gone black or mouldy. Hickory is a true tree nut, the same genus as pecan and the same family as walnut, and cross-reactivity is high: anyone with a pecan or walnut allergy should not eat them, since reactions can be anaphylactic.",
    "sources": [
      "Virginia Tech Dendrology Fact Sheet, Carya ovata (shagbark hickory) — https://dendro.cnre.vt.edu/dendrology/syllabus/factsheet.cfm?ID=20",
      "Virginia Tech Dendrology Fact Sheet, Carya cordiformis (bitternut hickory) — https://dendro.cnre.vt.edu/dendrology/syllabus/factsheet.cfm?ID=18",
      "Virginia Tech Dendrology Fact Sheet, Carya glabra (pignut hickory) — https://dendro.cnre.vt.edu/dendrology/syllabus/factsheet.cfm?ID=19",
      "USDA Forest Service, Silvics of North America: Shagbark Hickory (Carya ovata) — https://research.fs.usda.gov/silvics/shagbark-hickory",
      "Missouri Department of Conservation Field Guide, Shagbark Hickory — https://mdc.mo.gov/discover-nature/field-guide/shagbark-hickory",
      "NC State Extension Gardener Plant Toolbox, Aesculus hippocastanum (poison severity: high; prickly leathery capsule) — https://plants.ces.ncsu.edu/plants/aesculus-hippocastanum/",
      "NC State Extension Gardener Plant Toolbox, Aesculus glabra (warty or prickly leathery capsule; pale seed scar) — https://plants.ces.ncsu.edu/plants/aesculus-glabra/",
      "Missouri Poison Center, \"Horse Chestnut\" (esculin; clinical symptoms) — https://missouripoisoncenter.org/is-this-a-poison/horse-chestnut/",
      "Clemson Home & Garden Information Center, How to Identify and Control Poison Ivy — https://hgic.clemson.edu/factsheet/how-to-identify-and-control-poison-ivy-toxicodendron-radicans/",
      "Michigan State University Extension, \"Shagbark hickory: Another tasty local nut\" — https://www.canr.msu.edu/news/shagbark_hickory_another_tasty_local_nut"
    ]
  },
  {
